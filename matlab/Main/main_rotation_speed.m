...
%Method 1: statique (d�tection et interpolation sur chaque image du set)
...
%Method 2: dynamique (interpolation � partir de trajectoires)
...
%%
%Cercle moyen sur les 2 m�thodes
