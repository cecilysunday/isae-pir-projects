clc
interior_circle = [987.76,287.66,528.17];
R_LAYER_WIDE = 30;
PERCENT = 10; %in [0 100]
SKIPSTEP = 20;
...
profile_for_different_rotation_speed(PIXEL);
...
clear s_tr4 regions r_min r_max NB_LAYER_IN_SB NB_LAYER_OUT_SB data_tracking data_tracking2